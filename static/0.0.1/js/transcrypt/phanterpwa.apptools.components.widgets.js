// Transcrypt'ed from Python, 2020-02-21 00:47:30
...
export var Input =  __class__ ('Input', [Widget], {
	...
	get _binds () {return __get__ (this, function (self) {
		...
		target.off ('click.phanterpwa-event-input_materialize').on ('click.phanterpwa-event-input_materialize', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
...
export var Select =  __class__ ('Select', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier) {
		...
		var html = DIV (INPUT (__kwargtrans__ (dict ({'_id': 'phanterpwa-widget-select-input-{0}'.format (identifier), '_value': self._alias_value, '_placeholder': self._placeholder, '_disabled': 'disabled', '_data-validators': JSON.stringify (self._validator), '_data-form': self._form, '_name': self._name}))), label, DIV (I (__kwargtrans__ ({_class: 'fas fa-angle-down'})), __kwargtrans__ ({_class: 'phanterpwa-widget-select-caret'})), xml_icon, DIV (I (__kwargtrans__ ({_class: 'fas fa-check'})), __kwargtrans__ ({_class: 'phanterpwa-widget-check'})), DIV (__kwargtrans__ ({_class: 'phanterpwa-select-touchpad', _tabindex: '0'})), self._xml_select, DIV (self.get_message_error (), __kwargtrans__ ({_class: 'phanterpwa-widget-message_error phanterpwa-widget-select-message_error'})), __kwargtrans__ (wrapper_attr));
		Widget.__init__ (self, identifier, html, __kwargtrans__ (parameters));
	});},
...
export var ListString =  __class__ ('ListString', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier) {
		...
		var html = DIV (DIV (self._xml_list_string, __kwargtrans__ ({_id: 'phanterpwa-widget-list_string-list_values-{0}'.format (identifier), _class: 'phanterpwa-widget-list_string-list_values', _tabindex: 0})), INPUT (__kwargtrans__ (dict ({'_id': 'phanterpwa-widget-list_string-input-{0}'.format (identifier), '_class': 'phanterpwa-widget-list_string-input', '_name': self._name, '_value': self._input_value, '_placeholder': self._placeholder, '_type': 'hidden', '_data-validators': JSON.stringify (self._validator), '_data-form': self._form}))), label, DIV (I (__kwargtrans__ ({_class: 'fas fa-check'})), __kwargtrans__ ({_class: 'phanterpwa-widget-check'})), xml_icon, DIV (self.get_message_error (), __kwargtrans__ ({_class: 'phanterpwa-widget-message_error phanterpwa-widget-list_string-message_error'})), __kwargtrans__ (wrapper_attr));
		Widget.__init__ (self, identifier, html, __kwargtrans__ (parameters));
	});},
	...
	get add_new_value () {return __get__ (this, function (self, value) {
		...
		self._process_list_string ();
		self._process_list_string ();
		$ ('#phanterpwa-widget-list_string-input-{0}'.format (self.identifier)).val (self._input_value);
...
export var Inert =  __class__ ('Inert', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier) {
		...
		self._wear = parameters.py_get ('wear', 'material');
		self._form = parameters.py_get ('form', null);
		var wrapper_attr = dict ({'_class': 'phanterpwa-widget-wrapper its_disabled phanterpwa-widget-inert-wrapper phanterpwa-widget-wear-{0}'.format (self._wear)});
		parameters ['_id'] = identifier;
		if (__in__ ('_class', parameters)) {
...
export var MenuBox =  __class__ ('MenuBox', [Widget], {
	...
	get __init__ () {return __get__ (this, function (self, identifier) {
		...
		self.set_z_index (parameters.py_get ('z_index', null));
		self.set_recalc_on_scroll (parameters.py_get ('recalc_on_scroll', false));
		var html = DIV (self._icon, __kwargtrans__ ({_class: 'phanterpwa-widget-menubox-icon wave_on_click icon_button', _phanterpwa_dowpdown_target: 'drop_{0}'.format (self.identifier)}));
		if (__in__ ('_class', parameters)) {
	...
	get _on_click () {return __get__ (this, function (self, el) {
		...
		$ (el);
		self.modal = PseudoModal (self.target_selector, DIV (self._xml_menu, __kwargtrans__ ({_id: 'phanterpwa-widget-menubox-options-content-{0}'.format (self.identifier), _class: 'phanterpwa-widget-menubox-options-content'})), __kwargtrans__ ({vertical: true, z_index: self._z_index, recalc_on_scroll: self._recalc_on_scroll}));
		self.modal.start ();
		$ ('#phanterpwa-widget-menubox-options-content-{0}'.format (self.identifier)).find ('li').off ('click.close_pseudo_modal').on ('click.close_pseudo_modal', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
		...
		$ ('#phanterpwa-widget-menubox-options-content-{0}'.format (self.identifier)).find ('span').off ('click.close_pseudo_modal').on ('click.close_pseudo_modal', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
...
export var PseudoModal =  __class__ ('PseudoModal', [object], {
	...
	get _close_on_click_out () {return __get__ (this, function (self, event) {
		...
		if (!($ (event.target).hasClass ('phanterpwa-select-touchpad')) && !($ (event.target).hasClass ('phanterpwa-widget-select-label'))) {
