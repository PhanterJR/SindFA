// Transcrypt'ed from Python, 2020-02-28 04:51:53
...
export var WayHiperlinks =  __class__ ('WayHiperlinks', [Event], {
	...
	get start () {return __get__ (this, function (self) {
		...
		if ($ ('body').hasClass ('phanterpwa-lock')) {
			...
			$ (target_selector).find ('[phanterpwa-way]').off ('click.phanterpwa-way').on ('click.phanterpwa-way', (function __lambda__ () {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
...
export var Waves =  __class__ ('Waves', [Event], {
	...
	get _bind () {return __get__ (this, function (self, el, ev) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get start () {return __get__ (this, function (self) {
		...
		$ (target_selector).find ('.wave_on_click').off ('click.phanterpwa-event-wave').on ('click.phanterpwa-event-wave', (function __lambda__ (event) {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
