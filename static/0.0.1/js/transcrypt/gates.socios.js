// Transcrypt'ed from Python, 2020-02-20 05:11:08
...
export var Socio =  __class__ ('Socio', [helpers.XmlConstructor], {
	...
	get modal_add_dependentes () {return __get__ (this, function (self, widget_instance) {
		...
		$ ('#phanterpwa-widget-form-submit_button-adicionar').off ('click.adicionar_dependentes').on ('click.adicionar_dependentes', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
	...
	get modal_add_naturalidade () {return __get__ (this, function (self, widget_instance) {
		...
		$ ('#phanterpwa-widget-form-submit_button-adicionar').off ('click.adicionar_naturalidade').on ('click.adicionar_naturalidade', (function __lambda__ () {
			if (arguments.length) {
				var __ilastarg0__ = arguments.length - 1;
				if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
					var __allkwargs0__ = arguments [__ilastarg0__--];
