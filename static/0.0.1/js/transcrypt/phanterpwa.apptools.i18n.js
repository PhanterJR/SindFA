// Transcrypt'ed from Python, 2020-02-20 05:11:07
...
export var I18NServer =  __class__ ('I18NServer', [object], {
	...
	get get_translations_on_server () {return __get__ (this, function (self, new_word) {
		...
		if (window.PhanterPWA !== undefined) {
			if (window.PhanterPWA.DEBUG) {
				window.PhanterPWA.ApiServer.GET (__kwargtrans__ (dict ({'url_args': ['api', 'i18n'], 'url_vars': dict ({'lang': self.userLang, 'new_word': new_word}), 'onComplete': self.after_get_translations})));
			}
		}
	});},
	...
	get DOMTranslate () {return __get__ (this, function (self, target) {
		...
		if (self.target [0] !== undefined) {
			self.target.find ('[phanterpwa-i18n]').each ((function __lambda__ () {
				if (arguments.length) {
					var __ilastarg0__ = arguments.length - 1;
					if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
						var __allkwargs0__ = arguments [__ilastarg0__--];
