// Transcrypt'ed from Python, 2020-02-20 05:11:18
...
export var TopSlide =  __class__ ('TopSlide', [helpers.XmlConstructor], {
	...
	get start () {return __get__ (this, function (self) {
		...
		if (self.target_element !== null && self.target_element !== undefined) {
			self.target_element.find ('#phanterpwa-component-topslide-wrapper').remove ();
			self.target_element.append (self.jquery ());
			self.target_element.find ('.phanterpwa-component-topslide-close').off ('click.phanterpwa_component_topslide_close').on ('click.phanterpwa_component_topslide_close', self.close);
		}
	});}
});
