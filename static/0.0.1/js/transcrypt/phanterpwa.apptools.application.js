// Transcrypt'ed from Python, 2020-03-05 22:04:18
...
export var PhanterPWA =  __class__ ('PhanterPWA', [object], {
	...
	get __init__ () {return __get__ (this, function (self, config, gates) {
		...
		self.counter = 0;
		self.states = dict ();
		self._social_login_icons = dict ({'google': I (__kwargtrans__ ({_class: 'fab fa-google'})), 'facebook': I (__kwargtrans__ ({_class: 'fa-facebook'})), 'twitter': I (__kwargtrans__ ({_class: 'fab fa-twitter'}))});
	...
	get GET () {return __get__ (this, function (self) {
		...
		self.ApiServer (__kwargtrans__ (parameters));
	});},
