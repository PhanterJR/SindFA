// Transcrypt'ed from Python, 2020-02-25 16:52:16
...
export var Form =  __class__ ('Form', [helpers.XmlConstructor], {
	...
	get __init__ () {return __get__ (this, function (self, json_form) {
		...
		self.fields = fields;
		self.table_name = json_form ['table'];
		helpers.XmlConstructor.__init__ (self, 'phanterpwa-form', false, CSRFInput (self.table_name), __kwargtrans__ (parameters));
	...
	get target () {return __get__ (this, function (self, element) {
		...
		$ (self.element).find ('select').formSelect ();
		$ (self.element).phanterpwaFormValidator ();
		self.signForm ();
		return self.element;
	});},
