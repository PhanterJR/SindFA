// Transcrypt'ed from Python, 2020-03-04 22:28:44
...
var __name__ = 'gatehandlers.users';
...
export var Users =  __class__ ('Users', [helpers.XmlConstructor], {
	...
	get _get_data_search () {return __get__ (this, function (self, search, field, orderby, py_sort, page) {
		...
		window.PhanterPWA.ApiServer.GET (__kwargtrans__ (dict ({'url_args': ['api', 'usermanager'], 'url_vars': dict ({'search': search, 'field': field, 'orderby': orderby, 'sort': py_sort, 'page': page}), 'onComplete': self.after_get, 'get_cache': self.process_data})));
	});},
...
//# sourceMappingURL=gatehandlers.users.map