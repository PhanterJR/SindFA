...
class Socio(helpers.XmlConstructor):
    ...
    def visualizar(self, id_socio):
        self._carteira = DIV(
            DIV(
                DIV(
                    DIV(
                        DIV(_class="carteira-image"),
                        DIV(
                            ...
                            DIV(
                                DIV(
                                    ...
                                    DIV(_class="carteira-data-nome carteira-data-value"),
                            ...
                            DIV(
                                DIV(
                                    ...
                                    DIV(_class="carteira-data-matricula carteira-data-value"),
                                    _class="carteira-data-col"
                                ),
                                _class="p-col w1p40"
                            ),
                            DIV(
                                DIV(
                                    ...
                                    DIV(_class="carteira-data-cpf carteira-data-value"),
                                    _class="carteira-data-col"
                                ),
                                _class="p-col w1p60"
                            ),
                            DIV(
                                DIV(
                                    ...
                                    DIV(_class="carteira-data-dependentes carteira-data-value"),
                                    _class="carteira-data-col"
                                ),
                                _class="p-col w1p100"
                            ),
